...
const file_pb_user_user_proto_rawDesc = "" +
	"\n" +
	"\x12pb/user/user.proto\x12\x04user\"\x1d\n" +
	"\vUserRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\"D\n" +
	"\fUserResponse\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x10\n" +
	"\x03age\x18\x03 \x01(\x05R\x03age28\n" +
	"\x04User\x120\n" +
	"\aGetUser\x12\x11.user.UserRequest\x1a\x12.user.UserResponseB\x15Z\x13userservice/pb/userb\x06proto3"
